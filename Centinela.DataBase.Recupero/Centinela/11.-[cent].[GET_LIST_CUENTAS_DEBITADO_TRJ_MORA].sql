...
BEGIN
	EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [cent].[Get_List_Cuentas_Debitado_TRJ_Mora] AS'
END
GO


ALTER PROCEDURE [cent].[Get_List_Cuentas_Debitado_TRJ_Mora]
AS
/*****************************************************************************************************************
...
BEGIN		
	...
	ORDER BY [TC_CUENTAS_COBRO_MORA].[FECHA_REGISTRO] DESC
END
